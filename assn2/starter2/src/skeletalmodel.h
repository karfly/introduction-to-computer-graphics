...
public:
    ...
    void drawJoints_impl(const Camera& camera, const Joint * joint);
    ...
    void drawSkeleton_impl(const Camera& camera, const Joint * joint);
    ...
    void computeBindWorldToJointTransforms_impl(Joint * joint);
    void computeBindWorldToJointTransforms();

    // 2.3.2. Implement this method to compute a per-joint transform from
    // joint space to world space in the CURRENT POSE.
    void updateCurrentJointToWorldTransforms_impl(Joint * joint);
